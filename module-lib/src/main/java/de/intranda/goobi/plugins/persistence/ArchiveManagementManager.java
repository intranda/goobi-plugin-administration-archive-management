...
public class ArchiveManagementManager implements Serializable {
    ...
    public static IEadEntry getEadNodeWithMetadata(String metadataName, String metadataValue, List<IMetadataField> configuredFields) {
        IEadEntry entry = findNodeById(metadataName, metadataValue);
        if (entry != null) {
